...
#define PH_SENSOR1_PIN 39  // pH sensor pin
#define PH_SENSOR2_PIN 15  // pH sensor pin
...
bool currentMode = 0;  // 0 mean auto (defualt), 1 mean manual
...
// Parameters
#define LOWER_PH_THRESHOLD 6.5
#define UPPER_PH_THRESHOLD 9.0
#define CH4_THRESHOLD 95.0
#define LIQUID_PUMP_ON_DURATION 5000
#define GAS_PUMP_ON_DURATION 5000
