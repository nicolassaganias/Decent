...
#define PH_DIFFERENCE_THRESHOLD 0.5 // Máxima diferencia permitida entre pH1 y pH2
// calibration command
...
unsigned long lp2StartTime = 0;  // Momento en que se encendió LP2
...
const unsigned long PUMP_TOGGLE_INTERVAL = 10000; // 10s - Alternar GP2
