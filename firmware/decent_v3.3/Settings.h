...
bool manualMode = false;  // 0 mean auto (default), 1 mean manual
...
#define PH_DIFFERENCE_THRESHOLD 0.2 // Máxima diferencia permitida entre pH1 y pH2
// calibration command
...
unsigned long lastPumpToggleTime, lastPumpStartTime = 0;
unsigned long lp2StartTime,pumpOnTime = 0;  // Momento en que se encendió LP2

const unsigned long SENSOR_INTERVAL = 1000;  // 1s - Lectura de sensores
const unsigned long DISPLAY_INTERVAL = 2000; // 2s - Mostrar datos
const unsigned long PUMP_TOGGLE_INTERVAL = 60000; // 60s - Alternar GP2

// estos dos siguientes variables son para encender LP3 5 segundos cada 8 horas
#define PUMP_ON_TIME 5000  // Tiempo encendida en milisegundos (5 segundos)
#define PUMP_INTERVAL 28800000  // Intervalo de 8 horas en milisegundos (8 * 60 * 60 * 1000)

const unsigned long LP2_DURATION = 10000; // 10 segundos en ms
...
int speedGP1 = 140; // de 0 a 255 0 0% y 255 maximo caudal
int speedGP2 = 140;
int speedLP1 = 130;
int speedLP2 = 130;
int speedLP3 = 0;
